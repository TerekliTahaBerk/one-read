...
export const metadata: Metadata = {
  title: "Pricing - OneFilm",
  description: "Simple pricing for the OneFilm daily film note.",
};
    ...
    >
      ...
      <section className="mx-auto my-auto flex w-full max-w-[34rem] flex-col items-center py-8 text-center sm:py-10">
        ...
        <p className="mt-4 max-w-[42ch] animate-rise-delayed-2 text-[15px] leading-7 text-ash">
          Try OneFilm for a week. If it helps you choose better films without endless browsing, keep receiving one thoughtful film note for ${FILM_PRICING.monthly}/month or ${FILM_PRICING.yearly}/year.
        </p>
        <div className="mt-7 w-full rounded-2xl border border-[var(--theme-border)] bg-white/65 p-6 shadow-sm">
          <div className="font-serif text-[42px] text-ink">${FILM_PRICING.monthly}<span className="font-sans text-[14px] text-ash"> / month</span></div>
          <div className="mt-1 text-[13px] text-ash">${FILM_PRICING.yearly} yearly option available in Polar</div>
