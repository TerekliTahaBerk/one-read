...
export default function OneFilmOverviewPage({
  searchParams,
}: {
  ...
  return (
    <AdminShell
      title="OneFilm"
      subtitle="Inactive product · collecting demand on the waitlist"
    >
      <AdminCard title="Product status">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <p className="text-[13px] text-admin-body">
            ...
            Historical subscriber and delivery data remains preserved.
          </p>
        </div>
        <div className="mt-5 flex flex-wrap gap-3 text-[13px]">
          <a
            href="/waitlist?product=onefilm"
            target="_blank"
