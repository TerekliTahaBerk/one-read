...
export function LingoSubscribePageContent({ initialEmail }: { initialEmail: string }) {
  ...
  return (
    ...
    >
      <header className="relative flex w-full justify-center animate-rise">
        ...
        <Logo label="OneLingo" href="/" ariaLabel={dictionary.common.oneReadHome} />
      </header>
      <section className="mx-auto my-auto flex w-full max-w-[36rem] flex-col items-center py-8 sm:py-10">
        ...
        <LingoSubscribeLookup initialEmail={initialEmail} />
      </section>
