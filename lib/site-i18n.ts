...
const en = {
  ...
  home: {
    ...
    priceNote:
      "One subscription. One dollar. OneArticle included.",
  ...
  pricing: {
    ...
    intro:
      "One subscription includes OneArticle in the reading language you choose.",
    perMonth: "per month",
  ...
  signup: {
    ...
    articlePrefs: {
      ...
      support: "Every OneArticle edition will arrive in this language. You can change it later.",
      summaryLanguage: "Reading language",
      sourceLanguage: "Source language",
      cta: "Save reading language",
    },
    filmPrefs: {
    ...
    errors: {
      ...
      needsSetup: "Please choose your OneArticle reading language first.",
    },
  },
  preferences: {
    title: "Manage your OneRead account.",
    support: "Look up your subscription to check status or edit your OneArticle reading language.",
    placeholder: "you@example.com",
...
const tr: SiteDictionary = {
  ...
  home: { title: "Her seferinde tek bir faydalı e-posta.", intro: "OneRead, özenle hazırlanan tek bir makaleyi seçtiğin okuma dilinde gelen kutuna getirir.", priceNote: "Tek abonelik. Bir dolar. OneArticle dahil.", tagline: "Kontrol edilecek bir akış yok. Yalnızca açmaya değer bir şey." },
  ...
  pricing: { title: "OneRead {price}.", intro: "Tek abonelik, seçtiğin okuma dilinde OneArticle’ı kapsar.", perMonth: "aylık", included: "Tek abonelik. OneArticle dahil.", features: ["OneArticle — hafta içi her sabah tek makale özeti", "İngilizce, Türkçe, İspanyolca, Fransızca veya Almanca oku", "Okuma dilini istediğin zaman düzenle", "Tek tıkla iptal — soru yok"], cta: "OneRead’i başlat", trustNotes: ["OneArticle dahil", "Uygulama yok", "İstediğin zaman iptal et", "Ödeme Polar tarafından güvenle işlenir"] },
  ...
  signup: {
    ...
    articlePrefs: { title: "Okuma dilini seç.", support: "Her OneArticle gönderisi bu dilde gelecek. Daha sonra değiştirebilirsin.", summaryLanguage: "Okuma dili", sourceLanguage: "Kaynak dili", cta: "Okuma dilini kaydet" },
    ...
    review: { title: "OneRead kurulumunu gözden geçir.", support: "Okuma dilini kontrol et ve güvenli ödemeye devam et.", emailLabel: "E-posta", priceLabel: "Fiyat", priceIncluded: "OneArticle dahil", complete: "Tercihler tamamlandı", notSetUp: "Henüz ayarlanmadı", editPreferences: "Tercihleri düzenle", cta: "{price} karşılığında OneRead'i başlat" },
    pleaseWait: "Lütfen bekle…",
    errors: { invalidEmail: "Lütfen geçerli bir e-posta gir.", generic: "Bir şeyler ters gitti. Lütfen tekrar dene.", invalidCode: "6 haneli kodu gir.", codeIncorrect: "Bu kod doğru değil. Tekrar dene.", codeExpired: "Bu kodun süresi doldu. Yeni bir tane iste.", chooseInterest: "En az bir ilgi alanı seç.", chooseGenre: "En az bir tür seç.", needsSetup: "Lütfen önce OneArticle okuma dilini seç." },
  },
  preferences: {
    title: "OneRead hesabını yönet.",
    support: "Durumunu kontrol etmek veya OneArticle okuma dilini düzenlemek için aboneliğini ara.",
...
const de: SiteDictionary = {
  ...
  home: { title: "Eine nützliche E-Mail nach der anderen.", intro: "OneRead bringt einen sorgfältig redigierten Artikel in deiner gewählten Lesesprache in dein Postfach.", priceNote: "Ein Abo. Ein Dollar. OneArticle ist enthalten.", tagline: "Kein Feed zum Prüfen. Nur etwas, das sich zu öffnen lohnt." },
  ...
  pricing: { title: "OneRead kostet {price}.", intro: "Ein Abo umfasst OneArticle in deiner gewählten Lesesprache.", perMonth: "pro Monat", included: "Ein Abo. OneArticle ist enthalten.", features: ["OneArticle — jeden Werktagmorgen ein Artikelbriefing", "Auf Englisch, Türkisch, Spanisch, Französisch oder Deutsch lesen", "Lesesprache jederzeit ändern", "Mit einem Klick kündigen — ohne Fragen"], cta: "OneRead starten", trustNotes: ["OneArticle enthalten", "Keine App", "Jederzeit kündbar", "Sichere Zahlungsabwicklung durch Polar"] },
  ...
  signup: {
    ...
    articlePrefs: { title: "Wähle deine Lesesprache.", support: "Jede OneArticle-Ausgabe kommt in dieser Sprache. Du kannst sie später ändern.", summaryLanguage: "Lesesprache", sourceLanguage: "Quellsprache", cta: "Lesesprache speichern" },
  ...
  preferences: {
    ...
    support: "Rufe deinen Abonnementstatus ab oder bearbeite deine OneArticle-Lesesprache.",
...
const fr: SiteDictionary = {
  ...
  home: { title: "Un e-mail utile à la fois.", intro: "OneRead dépose dans votre boîte un article soigneusement rédigé dans la langue de lecture choisie.", priceNote: "Un abonnement. Un dollar. OneArticle inclus.", tagline: "Aucun fil à consulter. Juste quelque chose qui mérite d’être ouvert." },
  ...
  pricing: { title: "OneRead coûte {price}.", intro: "Un abonnement inclut OneArticle dans la langue de lecture choisie.", perMonth: "par mois", included: "Un abonnement. OneArticle inclus.", features: ["OneArticle — un article chaque matin en semaine", "Lisez en anglais, turc, espagnol, français ou allemand", "Modifiez votre langue de lecture à tout moment", "Résiliation en un clic — sans questions"], cta: "Commencer OneRead", trustNotes: ["OneArticle inclus", "Aucune application", "Résiliez à tout moment", "Paiement sécurisé par Polar"] },
  ...
  signup: {
    ...
    articlePrefs: { title: "Choisissez votre langue de lecture.", support: "Chaque édition OneArticle arrivera dans cette langue. Vous pourrez la modifier plus tard.", summaryLanguage: "Langue de lecture", sourceLanguage: "Langue source", cta: "Enregistrer la langue" },
    ...
    review: { title: "Vérifiez votre configuration OneRead.", support: "Vérifiez votre langue de lecture et poursuivez vers le paiement sécurisé.", emailLabel: "E-mail", priceLabel: "Tarif", priceIncluded: "OneArticle inclus", complete: "Préférences complètes", notSetUp: "Pas encore configuré", editPreferences: "Modifier les préférences", cta: "Commencer OneRead pour {price}" },
  ...
  preferences: {
    ...
    support: "Consultez votre abonnement pour vérifier son statut ou modifier la langue de lecture OneArticle.",
