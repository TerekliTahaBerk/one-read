...
export const MOBILE_PAGE_EXTENSIONS = ["mobile.tsx", "mobile.ts"];
...
export function pageExtensionsFor(env = process.env) {
  return [
    ...
    ...(surfaceEnabled(env, "MOBILE_PREVIEW") ? MOBILE_PAGE_EXTENSIONS : []),
...
export const FORBIDDEN_PRODUCTION_ROUTES = [
  ...
  {
    id: "postponed-mobile-api",
    pattern: /^\/api\/mobile(\/|$)/,
    reason: "Mobile development is postponed and is not part of the OneArticle production surface.",
  },
  {
    id: "retired-products",
