  ...
  return (
    <LegalLayout title="Terms of Service" lastUpdated="June 16, 2026">
      <p>
        ...
        use One Read. Please read them alongside our{" "}
      ...
      <p>
        ...
        availability are provided on a best-effort basis and may change. We
        don&apos;t guarantee uninterrupted or error-free delivery.
      </p>
      ...
      <p>
        One Read may be offered as a paid subscription. If you subscribe to a
        paid plan, the current options are a monthly plan and a yearly plan, at
        the prices shown on our <a href="/pricing">pricing page</a> at the time
        you subscribe. Prices may change for future billing periods, and
      ...
      <p>
        ...
        <strong>original summary and commentary</strong> written for One Read,
        ...
        nothing in our emails should be read as One Read claiming to be the
      ...
      <p>
        ...
        The One Read name, design, and the summaries and commentary we write
        remain ours or our licensors&apos;. You may read and share a link to a
        summary, but you may not copy, resell, redistribute, scrape, or archive
        our summaries on a systematic basis.
      </p>
      ...
      <p>
        ...
        terms make up the entire agreement between you and One Read regarding the
        service.
      </p>
