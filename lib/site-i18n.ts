...
const en = {
  ...
  pricing: {
    ...
    intro:
      "One subscription includes OneArticle and OneFilm.",
    perMonth: "per month",
    included: "One subscription. OneArticle and OneFilm included.",
    features: [
      "OneArticle — one article brief every weekday morning",
      "OneFilm — one thoughtful film note every Saturday",
      "Read in English, Turkish, Spanish, French, or German",
      "Edit your reading language anytime",
      "One-click cancel — no questions asked",
    ],
    cta: "Start OneRead",
    trustNotes: ["OneArticle + OneFilm included", "No app", "Cancel anytime", "Billing handled securely by Polar"],
  },
  article: {
  ...
  signup: {
    email: {
      ...
      support: "Enter your email and we'll send a 6-digit code before you set up OneArticle and OneFilm.",
    ...
    review: {
      ...
      emailLabel: "Email",
      priceLabel: "Price",
      priceIncluded: "OneArticle and OneFilm included",
    ...
    errors: {
      ...
      needsSetup: "Please complete your OneArticle and OneFilm preferences first.",
    },
  },
  preferences: {
...
const tr: SiteDictionary = {
  ...
  signup: {
    email: { title: "OneRead'i nereye gönderelim?", support: "E-postanı gir; OneArticle ve OneFilm’i kurmadan önce sana 6 haneli bir kod gönderelim.", placeholder: "sen@ornek.com", cta: "Doğrulama kodu gönder" },
    ...
    review: { title: "OneRead kurulumunu gözden geçir.", support: "Tercihlerini kontrol et ve güvenli ödemeye devam et.", emailLabel: "E-posta", priceLabel: "Fiyat", priceIncluded: "OneArticle ve OneFilm dahil", complete: "Tercihler tamamlandı", notSetUp: "Henüz ayarlanmadı", editPreferences: "Tercihleri düzenle", cta: "{price} karşılığında OneRead'i başlat" },
    pleaseWait: "Lütfen bekle…",
    errors: { invalidEmail: "Lütfen geçerli bir e-posta gir.", generic: "Bir şeyler ters gitti. Lütfen tekrar dene.", invalidCode: "6 haneli kodu gir.", codeIncorrect: "Bu kod doğru değil. Tekrar dene.", codeExpired: "Bu kodun süresi doldu. Yeni bir tane iste.", chooseInterest: "En az bir ilgi alanı seç.", chooseGenre: "En az bir tür seç.", needsSetup: "Lütfen OneArticle ve OneFilm tercihlerini tamamla." },
  },
  preferences: {
...
const de: SiteDictionary = {
  ...
  signup: {
    ...
    review: { title: "Überprüfe deine OneRead-Einrichtung.", support: "Prüfe deine Präferenzen und fahre mit der sicheren Zahlung fort.", emailLabel: "E-Mail", priceLabel: "Preis", priceIncluded: "OneArticle und OneFilm sind enthalten", complete: "Präferenzen vollständig", notSetUp: "Noch nicht eingerichtet", editPreferences: "Präferenzen bearbeiten", cta: "OneRead für {price} starten" },
